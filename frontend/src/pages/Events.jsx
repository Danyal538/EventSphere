            ...
            <div className='mt-20'>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 mx-10">
                    {offlineEvents.map((event, index) => (
                        <div key={index} className="bg-white rounded-xl overflow-hidden shadow-md border border-[#FFFFFF] hover:shadow-lg transition-transform duration-300 hover:scale-105 cursor-pointer" onClick={() => navigate("/event-description", { state: { event } })}>
